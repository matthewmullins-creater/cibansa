(function(){
    ...
    app.controller("CoursesController",function(CoursesService,$scope,$http,$sce){
            ...
            $scope.init = function(a){
                ...
                coursesService.getCourses(a).then(
                    function(response){
            ...
            $scope.postComment = function(){
                if($scope.comment){
                    ...
                    $http.post(Django.url("courses-api:courses-post-comment"),
                            {courses:$scope.aObj.id,user:Django.user.id,comment:$scope.comment})
                    .then(function(response){
                        $scope.aObj.commentSubmitted =false
                        $scope.aObj.courses_comments.push(response.data)
                        $scope.comment=""
                    },function(response){
                        $scope.aObj.commentSubmitted =false
                    })
...
//
            $scope.postReply = function(ac,$index){
                ...
                if(replyComment){
                     $http.post(Django.url("courses-api:courses-post-comment-reply"),
